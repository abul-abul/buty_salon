<div class="modal-body">     
    <div class="form-group">
        ...
        {!! Form::email('email', null, ['placeholder' => trans('common.email'), 'class' => 'form-control login_email_rev']) !!}
    </div>
    <div class="form-group">
        <label for="recipient-name" class="control-label">{{trans('common.password')}}</label>
        {!! Form::password('password',['placeholder' => trans('common.password'), 'class' => 'form-control  login_review_password_rev']) !!}
    </div>
    <div class="modal-footer">
        <div class="row">
            <div class="col-xs-12 col-sm-6" style="margin-bottom:20px;">
                <button data-salonid="{{$salon->id}}" type="buuton" content="{{ csrf_token() }}" class="btn btn-primary login_review">{{trans('common.login')}}</button>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6" style="margin-bottom:20px;">
                <button type="buuton" content="{{ csrf_token() }}" class="btn btn-primary" id="log_rew">
                    <a style="color:white;" href="#" data-toggle="modal" data-target="#registration_review">{{trans('common.reg')}}</a>
                </button>
            </div>
