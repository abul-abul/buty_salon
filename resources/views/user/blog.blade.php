		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb pull-left">
		  			...
		  			<li class="active">{{trans('common.blog')}}</li>
				</ol>
			</div><!-- /.col-md-12 -->
		</div><!-- /.row -->
	</div><!-- /.container -->
                                ...
                                <article class="block white block-margin block-shadow">
                                    ...
                                    <div class="block-inner">
                                        <div class="block-title">
                                            <h1><a href="{{action('UsersController@getArticle',$article['id'])}}">{{$article['title']}}</a></h1>
                                        </div>
                                        ...
                                        <a href="{{action('UsersController@getArticle',$article['id'])}}"  class="btn"> {{trans('common.read_more')}}</a>
                                    </div>
                                </article>
                            </div>
                        </div>
